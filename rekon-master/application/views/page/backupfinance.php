                ...
                <div class="col s12 m8 l9">
                  ...
                  <table id="data-table-simple" class="responsive-table display dataTable centered" cellspacing="0" role="grid" aria-describedby="data-table-simple_info">
                    <thead>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="data-table-simple" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 200px;">Nilai Kontrak</th>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="data-table-simple" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 200px;">Nilai Tagihan</th>
                        <th class="sorting" tabindex="0" aria-controls="data-table-simple" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 200px;">Tanggal Bayar</th>
                        <th class="sorting" tabindex="0" aria-controls="data-table-simple" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 200px;">Nilai Pembayaran</th>
                        <th class="sorting" tabindex="0" aria-controls="data-table-simple" rowspan="1" colspan="2" aria-label="Start date: activate to sort column ascending" style="width: 200px;">Kurang Tagih</th>
                    ...
                    <tfoot>
                        <tr><th rowspan="1" colspan="1"></th><th rowspan="1" colspan="1">No.</th><th rowspan="1" colspan="1">SPK</th><th rowspan="1" colspan="1">Nilai Kontrak</th><th rowspan="1" colspan="1">Progres</th><th rowspan="1" colspan="1">Tanggal Penagihan</th><th rowspan="1" colspan="1">Nilai Tagihan</th><th rowspan="1" colspan="1">Tanggal Bayar</th><th rowspan="1" colspan="1">Nilai Pembayaran</th><th rowspan="2" colspan="1">Kurang Tagih</th><th rowspan="1" colspan="1">Modify</th></tr>
                    </tfoot>
                   ...
                   <td>                           <p>
                            ...
                            <td><?php echo $dataf->nilai_byr; ?></td>
                            <td><?php echo $dataf->kurang_tgh; ?></td>
                            <td> 
                                <?php 
