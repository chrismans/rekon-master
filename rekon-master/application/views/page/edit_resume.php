                      ...
                      <div class="container">
                        <div class="row">
                          <div class="col s12 m12 l12">
                            <h5 class="breadcrumbs-title">Edit Resume</h5>
                            <ol class="breadcrumb">
                                <li><a href="index-2.html">Dashboard</a></li>
                                <li><a href="<?=site_url('administrator/main/resume')?>">Resume</a></li>
        ...
        <div class="col s12 m12 l6">
                ...
                <div class="col s12 m12 l6"  style="width:100%;">
                  <div class="card-panel" style="width:100%;">                  
                    <h4 class="header2">Edit Resume</h4>
                    <div class="row">
                        <div class="row">
                     <form id="form1" name="form1" method="post" action="<?php echo site_url('action/edit_resume');?>" > 
                          <div class="input-field col s12">
                            <label for="nama_pemborong" class="active">Mandor</label>
                            <?php $id = $this->uri->segment(4);
                        $show_item = $this->db->get_where('tbl_resume', array("id"=>"$id"));
                            foreach ($show_item->result() as $datap) { ?>
                            <input type="hidden" value="<?=$datap->id;?>" id="id" name="id">
                            <input type="text" name="nama_pemborong" id="nama_pemborong" readonly="1" value="<?php echo $datap->nama_pemborong; ?>">
                            </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                            <input type="text" name="spk" readonly="1" id="spk" value="<?php echo $datap->spk; ?>">
                            <label for="spk" class="active">Surat Perintah Kerja</label>
                          </div> 
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                            <input type="text" name="nama_kavling" id="nama_kavling" value="<?php echo $datap->nama_kavling; ?>">
                            <label for="nama_kavling" class="active">Kavling</label>
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                            <input placeholder="" id="type" readonly="1" type="text" name="type" value="<?php echo $datap->type; ?>">
                            <label for="type" class="active">Type/Ukuran</label>
                          </div>
                        </div>                                                                                                                                          
                        <div class="row">
                          <div class="input-field col s12">
                            <input placeholder="" id="satuan" readonly="1" type="text" name="satuan" value="<?php echo $datap->satuan; ?>">
                            <label for="satuan" class="active">Satuan</label>
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                            <input placeholder="" id="harga_satuan" readonly="1" type="text" name="harga_satuan" value="<?php echo $datap->harga_satuan; ?>">
                        ...
                        <div class="row">
                          <div class="input-field col s12">
                            <input placeholder="" value="<?php echo $datap->minggulalu; ?>" id="minggulalu" type="text" name="minggulalu" onfocus="startCalculate()" onblur="stopCalc()">
                            <label for="minggulalu" class="active">S/D Minggu Lalu</label>
                          </div>
                        </div>                                                
                        <div class="row">
                          <div class="input-field col s12">
                            <input placeholder="" id="mingguini" value="<?php echo $datap->mingguini; ?>" type="text" name="mingguini" onfocus="startCalculate()" onblur="stopCalc()">
